...
mongoose
  ...
  .then(() => {
    // Run your code here, after you have insured that the connection was made 2 to six go here.
    let newRecipe ={
      title: 'Granma Christmas special',
      level: 'Amateur Chef',
  ...
  .then((data3)=>{
    ...
    console.log(`We're out of carrot cake!`)
  })
  .catch(error => {
